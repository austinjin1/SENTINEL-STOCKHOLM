...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.52\textwidth]{fig_encoder_toxigene.jpg}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.52\textwidth]{fig_encoder_biomotion.jpg}
\caption{BioMotion encoder. Diffusion U-Net learns healthy \textit{Daphnia magna} trajectory distributions; anomaly = reconstruction error (AUROC = 1.000).}
\label{fig:biomotion}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.78\textwidth]{fig2_sota_comparison.jpg}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.72\textwidth]{fig5_ablation.jpg}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.68\textwidth]{fig_lake_erie_timeline.jpg}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.68\textwidth]{fig_causal_network_v2.jpg}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.72\textwidth]{fig9_fpr_persistence.jpg}
...
\item Lin, HY et al. (2024). MTForestNet: Multi-Task Random Forest for Chemical--Gene Interaction Prediction. \textit{J. Cheminformatics} 16.
\item Senn, L et al. (2021). Transcriptomic Responses of Zebrafish to Environmental Toxicants. \textit{BMC Genomics} 22.
\item Gagn\'e, F et al. (2025). Pathway Enrichment Analysis for Municipal Effluent Exposure in Fish. \textit{Toxicol. Sci.}
\end{enumerate}
\end{multicols}
\normalsize
